...
metadata, and flags known contradictory claims without automatically deciding canon.
"""
...
def scan(root):
 ...
 for path in sorted(root.rglob("*.md")):
  ...
  # Batch/template files in the established creator-tool package are legitimate names.
