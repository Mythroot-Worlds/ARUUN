...
The live case source is the human adjudication queue. The blind benchmark is evaluation-only.
"""
...
def main():
 ...
 # Live reasoning must use the authoritative adjudication queue. The blind benchmark remains evaluation-only.
